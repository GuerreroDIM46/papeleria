...
@Configuration
@PropertySource({ "classpath:config/passwordsBD.properties", "classpath:config/rest.properties", "classpath:config/jackson.properties" })
...
//	    JpaVendorAdapter vendorAdapter = new HibernateJpaVendorAdapter(); // O pedirlo como parametro y que haga el Autowired
		...
		em.setMappingResources("jpa/Perro.orm.xml"); //para
        // escanear archivos xml...
        // leerValorDePropiedades?
